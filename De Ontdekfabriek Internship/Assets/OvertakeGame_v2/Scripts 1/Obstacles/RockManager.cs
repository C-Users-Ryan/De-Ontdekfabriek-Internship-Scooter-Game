...
namespace OvertakeGame
{
    public class RockManager : MonoBehaviour
    {
        ...
        // Travel axis: -RoadDirection.Current. Lateral (steer) axis: RoadDirection.SteerAxis.
        private void SpawnSingle()
        {
            var r = GetAvailable(); if (r == null) return;
            Vector3 pos = _player.position
                        + (-RoadDirection.Current) * spawnDistanceAhead
                        + RoadDirection.SteerAxis * PickSpawnSteer();
            pos.y = spawnY;
        ...
        private void SpawnCluster()
        {
            ...
            for (int i = 0; i < clusterCount; i++)
            {
                ...
                Vector3 pos = basePos
                            ...
                            + RoadDirection.SteerAxis * steer;
                pos.y = spawnY;
                r.Activate(pos, Random.Range(minScale, maxScale * 0.8f));
            }
        }

        // Returns a signed lateral offset along RoadDirection.SteerAxis.
