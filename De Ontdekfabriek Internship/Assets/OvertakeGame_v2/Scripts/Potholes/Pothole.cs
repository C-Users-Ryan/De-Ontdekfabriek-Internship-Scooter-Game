...
{
    /// <summary>
    /// Pooled pothole hazard. Scrolls with the world, triggers hit response on player contact.
    /// Scoring is delegated to GameManager.OnPlayerHitPothole(speedKmh) — speed-scaled
    /// deductions reward players who slow down before hazards.
    ///
    /// Pool: Never Instantiate or Destroy at runtime.
    /// PotholeManager calls Activate() / Deactivate().
    /// </summary>
