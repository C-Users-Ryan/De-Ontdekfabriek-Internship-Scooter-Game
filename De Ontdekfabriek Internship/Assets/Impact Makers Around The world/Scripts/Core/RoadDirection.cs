...
{
    /// <summary>
    /// Single source of truth for the travel direction and steer axis (M3, Req §2).
    /// All world-space code projects onto these axes — never onto hardcoded X/Z —
    /// so every spatial calculation stays correct after a 90° road turn.
    /// </summary>
