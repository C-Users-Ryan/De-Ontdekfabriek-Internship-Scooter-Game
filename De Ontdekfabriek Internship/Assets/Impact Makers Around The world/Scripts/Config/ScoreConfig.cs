...
{
    /// <summary>
    /// Every score value, deduction and on/off toggle (M19, M20, Req §7.5, §16). Each event type can be
    /// switched off on its own for workshop setups. Overtake base points live on the vehicle prefab (they
    /// vary by vehicle type, Req §7.1); the streak multiplier defined here scales them (M20).
    /// </summary>
