...
{
    /// <summary>
    /// Collision classification, grace charges and rewind tuning (M15, M16, M17,
    /// Req §7.4/§8). Together these guarantee the workshop completion promise: a
    /// session continues after every collision unless game-over is explicitly enabled.
    /// </summary>
