...
{
    /// <summary>
    /// Audio routing for the three-layer engine, ambient crossfade and SFX pool
    /// (Req §11). Every clip field is optional — AudioManager is null-safe so the
    /// game runs silently until clips are imported (audio assets are a known
    /// backlog item).
    /// </summary>
