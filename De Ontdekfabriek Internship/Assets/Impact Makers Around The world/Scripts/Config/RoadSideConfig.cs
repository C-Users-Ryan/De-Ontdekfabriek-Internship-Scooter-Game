...
{
    /// <summary>
    /// Which side of the road the country drives on, plus lane geometry (M9, Req §4.5).
    /// Swapping the game to a new location only requires a new instance of this asset
    /// (SC1 — modular location system). All lane logic reads from RoadSideConfig.Active.
    /// </summary>
