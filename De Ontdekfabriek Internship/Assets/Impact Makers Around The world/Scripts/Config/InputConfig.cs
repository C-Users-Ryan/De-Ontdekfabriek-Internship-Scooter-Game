...
{
    /// <summary>
    /// Input feel for all providers (M5, M8, Req §3.1/§3.4). The same asset serves the
    /// iPad build (gyro + touch zones) and the desktop test build (keyboard/gamepad).
    /// </summary>
    ...
    public sealed class InputConfig : ScriptableObject
    {
        ...
        [Tooltip("How fast held A/D ramps toward full steer — approximates the gradual feel of tilting.")]
        public float keyboardSteerRate = 5f;
