...
{
    /// <summary>
    /// Spawn distances and gap rules for both lanes (M9, M10, M11). The oncoming minimum gap is the
    /// key promise: every overtake the game offers can actually be completed, so a failed overtake is
    /// down to the player's judgement, not an unfair setup (MDA Chain 1).
    /// </summary>
    ...
    public sealed class TrafficConfig : ScriptableObject
    {
        ...
        public float minimumCarGap = 20f;
